...
export const exportServiceV2 = {
  ...
  async ledgerToPdf(entries: any[], profile: any) {
    ...
    (doc as any).autoTable({
      ...
      headStyles         : { fillColor: DARK_HEADER, fontStyle: 'bold', fontSize: 9 },
  ...
  async fullReportToPdf(data: {
    ...
    (doc as any).autoTable({
      ...
      headStyles         : { fillColor: DARK_HEADER, fontSize: 9 },
      bodyStyles         : { fontSize: 9 },
      alternateRowStyles : { fillColor: ALT_ROW },
    ...
    (doc as any).autoTable({
      ...
      headStyles         : { fillColor: DARK_HEADER, fontSize: 10 },
      bodyStyles         : { fontSize: 10 },
      alternateRowStyles : { fillColor: ALT_ROW },
    ...
    if (lowStock.length > 0) {
      ...
      (doc as any).autoTable({
        ...
        headStyles         : { fillColor: RED_HEADER, fontSize: 9 },
        bodyStyles         : { fontSize: 9, textColor: [140, 30, 30] },
